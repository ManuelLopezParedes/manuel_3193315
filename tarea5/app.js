...
function agregarProducto(){
    producto = prompt("escriba el producto")
    costo= parseInt(prompt("escribe el precio del producto"))
    var nuevoProducto={nombre:producto, precio:costo}
