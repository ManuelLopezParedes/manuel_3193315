...
router.get('/page1', (req, res) => {res.sendFile(path.join(__dirname, '../public', 'page1.html'));}) // Define una ruta GET para page1. Cuando el usuario accede a http://localhost:3000/page1, esta ruta envía el archivo page1.html como respuesta.
router.get('/page2', (req, res) => {res.sendFile(path.join(__dirname, '../public', 'page2.html'));}) //Hace lo mismo para la página 2.
router.get('/page3', (req, res) => {res.sendFile(path.join(__dirname, '../public', 'page3.html'));}) //Hace lo mismo para la página 3.
...
path.join(__dirname, '../public', 'page1.html') // __dirname es una variable global que contiene la ruta del directorio actual (routes en este caso), y luego usamos path.join para movernos a la carpeta public (subiendo un nivel ../) y acceder al archivo page1.html.
